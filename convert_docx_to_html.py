                    ...
                    <li class="relative group">
                        ...
                        <div id="practice-dropdown" class="hidden absolute top-full mt-2 right-0 w-64 bg-white rounded-lg shadow-xl border border-gray-200 z-50 py-2" style="max-height: calc(100vh - 120px); overflow-y: auto;">
                            ...
                            <div class="border-b border-gray-200 bg-amber-50">
                                <button onclick="toggleCategoryDropdown('category-family', event)" class="w-full px-4 py-2 flex items-center justify-between text-right hover:bg-amber-100" style="background: linear-gradient(90deg, #fef3c7, #fff);"><h4 class="font-bold text-[#b8941f] text-sm">דיני משפחה וגירושין</h4><span class="category-icon text-xs text-[#b8941f]">▼</span></button>
                                <div id="category-family" class="hidden">
                                    <a href="divorce-guide.html" class="block px-4 py-2 pr-8 text-sm text-yellow-700 font-bold hover:bg-[#c9a55c] hover:text-[#1a1a1a] text-right">המדריך המלא לגירושין</a>
                                    <div class="pillar-group" style="background: #fffbeb; border-right: 3px solid #c9a55c; margin: 2px 0; border-bottom: 1px solid #e5e7eb;"><div class="flex items-center pr-8 hover:bg-amber-100"><span onclick="toggleSubCategory('sub-heskem-gerushin', event)" class="flex-1 py-2 text-sm text-[#92700c] hover:text-[#c9a55c] font-semibold cursor-pointer">הסכם גירושין</span><a href="heskem-gerushin.html" class="px-3 py-1 text-xs font-bold text-[#1a1a1a] bg-[#c9a55c] rounded hover:bg-[#b8941f]">לעמוד ←</a><button onclick="toggleSubCategory('sub-heskem-gerushin', event)" class="px-2 py-1 text-xs text-gray-400 hover:text-[#c9a55c]">▼</button></div><div id="sub-heskem-gerushin" class="hidden bg-gray-50 pr-12"><a href="mahu-heskem-gerushin.html" class="block py-2 px-4 text-sm text-gray-600 hover:text-[#c9a55c] border-b border-gray-200">מהו הסכם גירושין</a><a href="shlvei-heskem-gerushin.html" class="block py-2 px-4 text-sm text-gray-600 hover:text-[#c9a55c] border-b border-gray-200">שלבי הסכם</a><a href="seifim-hova-heskem.html" class="block py-2 px-4 text-sm text-gray-600 hover:text-[#c9a55c]">סעיפי חובה</a></div></div>
                                    <div class="pillar-group" style="background: #fffbeb; border-right: 3px solid #c9a55c; margin: 2px 0; border-bottom: 1px solid #e5e7eb;"><div class="flex items-center pr-8 hover:bg-amber-100"><span onclick="toggleSubCategory('sub-beit-din', event)" class="flex-1 py-2 text-sm text-[#92700c] hover:text-[#c9a55c] font-semibold cursor-pointer">בית דין רבני</span><a href="gerushin-beit-din-rabani.html" class="px-3 py-1 text-xs font-bold text-[#1a1a1a] bg-[#c9a55c] rounded hover:bg-[#b8941f]">לעמוד ←</a><button onclick="toggleSubCategory('sub-beit-din', event)" class="px-2 py-1 text-xs text-gray-400 hover:text-[#c9a55c]">▼</button></div><div id="sub-beit-din" class="hidden bg-gray-50 pr-12"><a href="haget-mah-ze.html" class="block py-2 px-4 text-sm text-gray-600 hover:text-[#c9a55c] border-b border-gray-200">הגט - מה זה</a><a href="smchut-beit-din-rabani.html" class="block py-2 px-4 text-sm text-gray-600 hover:text-[#c9a55c]">סמכות בית דין</a></div></div>
                                    <div class="pillar-group" style="background: #fffbeb; border-right: 3px solid #c9a55c; margin: 2px 0; border-bottom: 1px solid #e5e7eb;"><div class="flex items-center pr-8 hover:bg-amber-100"><span onclick="toggleSubCategory('sub-mishmoret', event)" class="flex-1 py-2 text-sm text-[#92700c] hover:text-[#c9a55c] font-semibold cursor-pointer">משמורת ילדים</span><a href="mishmoret-yeladim.html" class="px-3 py-1 text-xs font-bold text-[#1a1a1a] bg-[#c9a55c] rounded hover:bg-[#b8941f]">לעמוד ←</a><button onclick="toggleSubCategory('sub-mishmoret', event)" class="px-2 py-1 text-xs text-gray-400 hover:text-[#c9a55c]">▼</button></div><div id="sub-mishmoret" class="hidden bg-gray-50 pr-12"><a href="mishmoret-blaudit-vsmeshuteft.html" class="block py-2 px-4 text-sm text-gray-600 hover:text-[#c9a55c] border-b border-gray-200">בלעדית vs משותפת</a><a href="achrayut-horit.html" class="block py-2 px-4 text-sm text-gray-600 hover:text-[#c9a55c]">אחריות הורית</a></div></div>
                                    <div class="pillar-group" style="background: #fffbeb; border-right: 3px solid #c9a55c; margin: 2px 0; border-bottom: 1px solid #e5e7eb;"><div class="flex items-center pr-8 hover:bg-amber-100"><span onclick="toggleSubCategory('sub-mezonot-yeladim', event)" class="flex-1 py-2 text-sm text-[#92700c] hover:text-[#c9a55c] font-semibold cursor-pointer">מזונות ילדים</span><a href="mezonot-yeladim.html" class="px-3 py-1 text-xs font-bold text-[#1a1a1a] bg-[#c9a55c] rounded hover:bg-[#b8941f]">לעמוד ←</a><button onclick="toggleSubCategory('sub-mezonot-yeladim', event)" class="px-2 py-1 text-xs text-gray-400 hover:text-[#c9a55c]">▼</button></div><div id="sub-mezonot-yeladim" class="hidden bg-gray-50 pr-12"><a href="chishov-mezonot-yeladim.html" class="block py-2 px-4 text-sm text-gray-600 hover:text-[#c9a55c] border-b border-gray-200">חישוב מזונות</a><a href="hafchatat-mezonot-yeladim.html" class="block py-2 px-4 text-sm text-gray-600 hover:text-[#c9a55c]">הפחתת מזונות</a></div></div>
                                    <div class="pillar-group" style="background: #fffbeb; border-right: 3px solid #c9a55c; margin: 2px 0; border-bottom: 1px solid #e5e7eb;"><div class="flex items-center pr-8 hover:bg-amber-100"><span onclick="toggleSubCategory('sub-mezonot-isha', event)" class="flex-1 py-2 text-sm text-[#92700c] hover:text-[#c9a55c] font-semibold cursor-pointer">מזונות אישה</span><a href="mezonot-isha.html" class="px-3 py-1 text-xs font-bold text-[#1a1a1a] bg-[#c9a55c] rounded hover:bg-[#b8941f]">לעמוד ←</a><button onclick="toggleSubCategory('sub-mezonot-isha', event)" class="px-2 py-1 text-xs text-gray-400 hover:text-[#c9a55c]">▼</button></div><div id="sub-mezonot-isha" class="hidden bg-gray-50 pr-12"><a href="zkaut-mezonot-isha.html" class="block py-2 px-4 text-sm text-gray-600 hover:text-[#c9a55c] border-b border-gray-200">זכאות למזונות</a><a href="chishov-mezonot-isha.html" class="block py-2 px-4 text-sm text-gray-600 hover:text-[#c9a55c]">חישוב מזונות</a></div></div>
                                    <div class="pillar-group" style="background: #fffbeb; border-right: 3px solid #c9a55c; margin: 2px 0; border-bottom: 1px solid #e5e7eb;"><div class="flex items-center pr-8 hover:bg-amber-100"><span onclick="toggleSubCategory('sub-rechush', event)" class="flex-1 py-2 text-sm text-[#92700c] hover:text-[#c9a55c] font-semibold cursor-pointer">חלוקת רכוש</span><a href="chalokat-rechush-gerushin.html" class="px-3 py-1 text-xs font-bold text-[#1a1a1a] bg-[#c9a55c] rounded hover:bg-[#b8941f]">לעמוד ←</a><button onclick="toggleSubCategory('sub-rechush', event)" class="px-2 py-1 text-xs text-gray-400 hover:text-[#c9a55c]">▼</button></div><div id="sub-rechush" class="hidden bg-gray-50 pr-12"><a href="izun-mashabim-gerushin.html" class="block py-2 px-4 text-sm text-gray-600 hover:text-[#c9a55c] border-b border-gray-200">איזון משאבים</a><a href="chalokat-dira-gerushin.html" class="block py-2 px-4 text-sm text-gray-600 hover:text-[#c9a55c]">חלוקת דירה</a></div></div>
                                    <div class="pillar-group" style="background: #fffbeb; border-right: 3px solid #c9a55c; margin: 2px 0; border-bottom: 1px solid #e5e7eb;"><div class="flex items-center pr-8 hover:bg-amber-100"><span onclick="toggleSubCategory('sub-mamon', event)" class="flex-1 py-2 text-sm text-[#92700c] hover:text-[#c9a55c] font-semibold cursor-pointer">הסכם ממון</span><a href="heskem-mamon.html" class="px-3 py-1 text-xs font-bold text-[#1a1a1a] bg-[#c9a55c] rounded hover:bg-[#b8941f]">לעמוד ←</a><button onclick="toggleSubCategory('sub-mamon', event)" class="px-2 py-1 text-xs text-gray-400 hover:text-[#c9a55c]">▼</button></div><div id="sub-mamon" class="hidden bg-gray-50 pr-12"><a href="heskem-mamon-lifney-nisuin.html" class="block py-2 px-4 text-sm text-gray-600 hover:text-[#c9a55c] border-b border-gray-200">לפני נישואין</a><a href="hagana-al-esek.html" class="block py-2 px-4 text-sm text-gray-600 hover:text-[#c9a55c]">הגנה על עסק</a></div></div>
                                    <div class="pillar-group" style="background: #fffbeb; border-right: 3px solid #c9a55c; margin: 2px 0; border-bottom: 1px solid #e5e7eb;"><div class="flex items-center pr-8 hover:bg-amber-100"><span onclick="toggleSubCategory('sub-sarvanut', event)" class="flex-1 py-2 text-sm text-[#92700c] hover:text-[#c9a55c] font-semibold cursor-pointer">סרבנות גט</span><a href="sarvanut-get-agunot.html" class="px-3 py-1 text-xs font-bold text-[#1a1a1a] bg-[#c9a55c] rounded hover:bg-[#b8941f]">לעמוד ←</a><button onclick="toggleSubCategory('sub-sarvanut', event)" class="px-2 py-1 text-xs text-gray-400 hover:text-[#c9a55c]">▼</button></div><div id="sub-sarvanut" class="hidden bg-gray-50 pr-12"><a href="klim-mishpatiyim-sarvan-get.html" class="block py-2 px-4 text-sm text-gray-600 hover:text-[#c9a55c] border-b border-gray-200">כלים משפטיים</a><a href="agunut-ma-laasot.html" class="block py-2 px-4 text-sm text-gray-600 hover:text-[#c9a55c]">עגינות - מה לעשות</a></div></div>
                                    <div class="pillar-group" style="background: #fffbeb; border-right: 3px solid #c9a55c; margin: 2px 0; border-bottom: 1px solid #e5e7eb;"><div class="flex items-center pr-8 hover:bg-amber-100"><span onclick="toggleSubCategory('sub-yaduyim', event)" class="flex-1 py-2 text-sm text-[#92700c] hover:text-[#c9a55c] font-semibold cursor-pointer">ידועים בציבור</span><a href="yaduyim-batzibur.html" class="px-3 py-1 text-xs font-bold text-[#1a1a1a] bg-[#c9a55c] rounded hover:bg-[#b8941f]">לעמוד ←</a><button onclick="toggleSubCategory('sub-yaduyim', event)" class="px-2 py-1 text-xs text-gray-400 hover:text-[#c9a55c]">▼</button></div><div id="sub-yaduyim" class="hidden bg-gray-50 pr-12"><a href="zkuyot-yaduyim-batzibur.html" class="block py-2 px-4 text-sm text-gray-600 hover:text-[#c9a55c] border-b border-gray-200">זכויות</a><a href="heskem-yaduyim-batzibur.html" class="block py-2 px-4 text-sm text-gray-600 hover:text-[#c9a55c]">הסכם חיים משותפים</a></div></div>
                                    <a href="divorce.html" class="block px-4 py-2 pr-8 text-sm text-gray-700 hover:bg-[#c9a55c] hover:text-[#1a1a1a] text-right">גירושין</a>
                                    <a href="guardianship.html" class="block px-4 py-2 pr-8 text-sm text-gray-700 hover:bg-[#c9a55c] hover:text-[#1a1a1a] text-right">אפוטרופסות</a>
                                    <a href="mediation.html" class="block px-4 py-2 pr-8 text-sm text-gray-700 hover:bg-[#c9a55c] hover:text-[#1a1a1a] text-right">גישור משפחתי</a>
                                </div>
                            </div>
                            <!-- ירושות וצוואות -->
    ...
    <div id="mobile-menu" class="mobile-menu-overlay">
        ...
        <nav class="p-6">
            <ul class="space-y-4">
                ...
                <li>
                    <button onclick="toggleNavDropdown('mobile-practice-dropdown')" class="block w-full text-right text-lg" style="background: #1a1a1a; color: #c9a55c; border: none; cursor: pointer; padding: 1rem; text-align: right; font-size: 1.125rem;">תחומי התמחות <span style="margin-right: 0.5rem;">▼</span></button>
                    <div id="mobile-practice-dropdown" class="hidden w-full mt-2" style="background: #2a2a2a; padding: 1rem; border-radius: 8px;">
                        <div style="margin-bottom: 12px;">
                            <button onclick="toggleCategoryDropdown('mobile-category-family', event)" style="display: flex; width: 100%; background-color: #1a1a1a; color: #c9a55c; border: 2px solid #c9a55c; border-radius: 8px; padding: 14px 16px; font-size: 16px; font-weight: bold; text-align: right; justify-content: space-between; align-items: center; cursor: pointer;"><span style="color: #c9a55c;">דיני משפחה</span><span style="color: #c9a55c;">▼</span></button>
                        ...
                        <div style="margin-bottom: 12px;">
                            <button onclick="toggleCategoryDropdown('mobile-category-inheritance', event)" style="display: flex; width: 100%; background-color: #1a1a1a; color: #c9a55c; border: 2px solid #c9a55c; border-radius: 8px; padding: 14px 16px; font-size: 16px; font-weight: bold; text-align: right; justify-content: space-between; align-items: center; cursor: pointer;"><span style="color: #c9a55c;">ירושות וצוואות</span><span style="color: #c9a55c;">▼</span></button>
                        ...
                        <div style="margin-bottom: 12px;">
                            <button onclick="toggleCategoryDropdown('mobile-category-bankruptcy', event)" style="display: flex; width: 100%; background-color: #1a1a1a; color: #c9a55c; border: 2px solid #c9a55c; border-radius: 8px; padding: 14px 16px; font-size: 16px; font-weight: bold; text-align: right; justify-content: space-between; align-items: center; cursor: pointer;"><span style="color: #c9a55c;">חדלות פירעון והוצאה לפועל</span><span style="color: #c9a55c;">▼</span></button>
                        ...
                        <div class="mb-2"><a href="practice-areas.html#civil-law" class="block w-full text-right py-3 px-4 text-white font-bold text-base bg-gray-800 rounded-lg hover:bg-gray-700">דיני חוזים ודיני מקרקעין</a></div>
                    </div>
                </li>
