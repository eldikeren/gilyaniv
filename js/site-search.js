...
(function () {
  ...
  var CSS_URL = '/css/search-modal.css?v=20260321';
  var MAX_RESULTS = 8;
  var DEBOUNCE_MS = 200;
  ...
  function injectMobileMenuExtras() {
    ...
    socialDiv.style.cssText = 'display:flex;gap:12px;justify-content:center;margin-top:1.5rem;padding:1rem 0;border-top:1px solid rgba(92, 69, 16,0.2);';
    socialDiv.innerHTML =
      '<a href="https://www.facebook.com/people/%D7%99%D7%A0%D7%99%D7%91-%D7%92%D7%99%D7%9C-%D7%95%D7%A9%D7%95%D7%AA-%D7%9E%D7%A9%D7%A8%D7%93-%D7%A2%D7%95%D7%93/100063695315034/" target="_blank" rel="noopener" title="Facebook" aria-label="Facebook" style="display:flex;align-items:center;justify-content:center;width:44px;height:44px;border-radius:50%;border:1px solid rgba(92, 69, 16,0.4);color:#5c4510;transition:all 0.3s;">' +
        '<svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>' +
      '</a>' +
      '<a href="https://www.instagram.com/yanivgiladv/" target="_blank" rel="noopener" title="Instagram" aria-label="Instagram" style="display:flex;align-items:center;justify-content:center;width:44px;height:44px;border-radius:50%;border:1px solid rgba(92, 69, 16,0.4);color:#5c4510;transition:all 0.3s;">' +
